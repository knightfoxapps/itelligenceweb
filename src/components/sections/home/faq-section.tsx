      ...
      <div className="container">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          >
            ...
            <p className="mb-10 text-lg text-muted-foreground md:mb-12">
              Clear answers to what matters most about our approach.
            </p>

            {/* Accordion — answers in initial HTML for SEO (collapsed with CSS) */}
              ...
              {faqs.map((faq, i) => (
                ...
                >
                  ...
                  <Accordion.Content className="overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down">
                    <p className="pb-5 text-muted-foreground md:pb-6">
                      {faq.answer}
                    </p>
                  </Accordion.Content>
                </Accordion.Item>
            ...
            <div className="mt-10 md:mt-14">
              <h3 className="mb-3 text-2xl font-bold">Still curious?</h3>
              <p className="text-muted-foreground">
                Straight answers are our standard. Ask us anything.
              </p>
              <div className="mt-6">
          ...
          >
            <Image
              ...
              alt="itelligenceCX team collaboration"
              width={600}
              height={800}
