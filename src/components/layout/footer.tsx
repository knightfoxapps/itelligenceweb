...
const footerLinks = {
  ...
  company: [
    ...
    { label: "Performance Pilot", href: "/performance-pilot" },
  ],
};
...
export function Footer() {
  return (
    <footer className="bg-gray-850 text-white">
      <div className="container px-[5%] py-16 md:py-20">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-400 max-w-xs">
              Intelligence-led nearshore CX delivery. Performance by design.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <p className="text-xs text-gray-500">
            © {new Date().getFullYear()} itelligenceCX. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
